...
import { Settings, Sparkles, ChevronDown, ChevronUp, AlertCircle, Copy, Check } from 'lucide-react';
...
const StickyHeader = styled('div', {
  ...
  margin: '0 -$5 $5 -$5', // Pull to edges of AppContainer
  padding: '$5 $5 $2 $5', // Restore padding inside
    ...
    <RootContainer>
      <AppContainer>
        <StickyHeader>
          <Header>
            <h1>CreFlux</h1>
            <p>Unleash the ultimate hallucination. Break the boundaries of logic.</p>
          </Header>
